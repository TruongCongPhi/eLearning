...
<?php
    ...
    ?>
<form id="id_form" action="update_quizz.php?course_id=<?= $_GET['course_id'] ?>&lecture_id=<?= $_GET['lecture_id'] ?>"
    method="post">
            ...
            <div class="col-12 mb-3">
                <div class="card rounded-4 p-3">
                    ...
                    <div class="form-check p-3">
                        <input class="form-check-input" name="choice_<?= $question['id'] ?>" type="radio"
                            value="<?= $data2['id'] ?>">
                    ...
                    <?php
                                    ...
                                    ?>
                    <div class='form-check p-3'>
                        <input class="form-check-input" name="choice_<?= $question['id'] ?>[]"
                            value="<?= $data2['id'] ?>" type='checkbox'>
    ...
    <button style="position: fixed;left: 90%;top: 50vh;" data-bs-toggle="modal" data-bs-target="#cf" type="button"
        class="btn btn-info">Nộp
        bài</button>
...
<a class="btn btn-primary"
    href="bai_giang.php?course_id=<?= $_GET['course_id'] ?>&lecture_id=<?= $_GET['lecture_id'] ?>">Trở lại</a>
<?php }
}
?>
...
var thoiGianLamBai = 600; // đơn vị là giây
